...
import com.colemichaels.masterdetailflowdemo.databinding.FragmentWebsiteListBinding
import com.colemichaels.masterdetailflowdemo.databinding.WebsiteListContentBinding
...
class WebsiteListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val onClickListener = View.OnClickListener { itemView ->
            ...
            bundle.putString(
                WebsiteDetailFragment.ARG_ITEM_NAME,
                item.website_name
            )
